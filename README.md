...
- **HTML5 & CSS3:** Kustomisasi skema warna *brand* SENNA (`#a67c1e`).
- **Framework UI:** [Bootstrap 5](https://getbootstrap.com/) & [Bootstrap Icons](https://icons.getbootstrap.com/)
- **Animasi & Interaktivitas:**
  - [AOS (Animate On Scroll)](https://michalsnik.github.io/aos/)
  - [GLightbox](https://biati-digital.github.io/glightbox/)
  - [Isotope Layout](https://isotope.metafizzy.co/)
  - [Swiper Touch Slider](https://swiperjs.com/)
...
├── produk.html                  # Halaman katalog produk lengkap
├── detail-*.html                # Halaman detail produk OPPLE
├── assets/
│   ├── css/                     # Modul CSS utama (main.css)
│   ├── js/                      # Script interaksi (main.js)
│   ├── img/                     # Logo SENNA/OPPLE, banner, & foto produk
│   └── vendor/                  # Library pustaka (Bootstrap, AOS, GLightbox, dsb.)
└── forms/                       # Handler PHP untuk backend formulir kontak
